...
GENERATOR_CONFIG = [
    ...
    {"input_dim": 256, "output_dim": DATA_DIM, "activation": nn.Tanh(), "batch_norm": False, "dropout": 0.0},  # No dropout on the last layer
]
...
DISCRIMINATOR_CONFIG = [
    ...
    {"input_dim": 32, "output_dim": 1, "activation": nn.Sigmoid(), "batch_norm": False, "dropout": 0.0},  # No dropout on the output layer
]
