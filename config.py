...
WEIGHT_DECAY = 1e-4
LAMBDA_K = 2e-1     # Learning rate for `k_t` balance term, for BEGAN.
LAMBDA_CORR = 0.5   # Level of influence of the correlation loss on global loss
GAMMA = 0.5        # BEGAN balance factor
